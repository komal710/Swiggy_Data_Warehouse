...
CREATE OR REPLACE TABLE consumption_sch.order_item_fact (
    ...
    order_item_id NUMBER not null comment 'Order Item FK (Source System)',                    -- Natural key from the source data
    order_id NUMBER not null comment 'Order FK (Source System)',                         -- Reference to the order dimension
    customer_dim_key NUMBER not null comment 'Order FK (Source System)',                      -- Reference to the customer dimension
